...
/* Converts a user-specified quality rating to a percentage scaling factor
 ...
 */
{
  /* Converts user 0-100 rating to percentage scaling */
...
jpeg_set_defaults (j_compress_ptr cinfo)
{
  ...
  /* Allocates comp_info array large enough for maximum component count.
...
#define SET_COMP(index,id,hsamp,vsamp,quant,dctbl,actbl)  \
  ...
  case JCS_BG_RGB:
    ...
    cinfo->num_components = 3;
    /* Adds offset 0x20 to the normal R/G/B component IDs */
  ...
  case JCS_BG_YCC:
    ...
    cinfo->JFIF_major_version = 2;   /* Set JFIF major version = 2 */
    cinfo->num_components = 3;
    /* Adds offset 0x20 to the normal Cb/Cr component IDs */
    /* We default to 2x2 subsamples of chrominance */
    SET_COMP(0, 0x01, 2,2, 0, 0,0);
...
/*
 * Creates a recommended progressive-JPEG script.
