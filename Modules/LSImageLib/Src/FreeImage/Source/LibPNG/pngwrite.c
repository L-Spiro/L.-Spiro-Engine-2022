...
png_set_filter(png_structrp png_ptr, int method, int filters)
{
   ...
   if (method == PNG_FILTER_TYPE_BASE)
   {
       ...
       * Removes them after the start of compression.
       */
    ...
    int transforms, voidp params)
{
   ...
   /* Removes a filler (X) from XRGB/RGBX/AG/GA into to convert it into
   ...
   png_uint_32 reciprocal/*from the above macro*/)
{
   ...
   else if (component > 0)
   {
      ...
      /* Converts the component to sRGB. */
...
#  endif
    ...
    * Removes the handled transformations from the 'format' flags for checking.
    *
