...
/* Handles alpha and tRNS via a background color */
void PNGFAPI
...
#ifdef PNG_FLOATING_POINT_SUPPORTED
/* Converts a RGB image to a grayscale of the same width.  This allows us,
...
#ifdef PNG_READ_FILLER_SUPPORTED
/* Adds filler channel if we have RGB color */
static void
