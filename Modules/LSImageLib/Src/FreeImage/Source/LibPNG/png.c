...
/* Allocates the memory for an info_struct for the application. */
...
/* Converts the supplied time into an RFC 1123 string suitable for use in
...
/* Builds a grayscale palette.  Palette is assumed to be 1 << bit_depth
   ...
   png_const_bytep profile/* first 132 bytes only */, int color_type)
{
    ...
    * 6), or a greyscale color space for greyscale images (PNG color types 0
    * and 4)."
    *
...
png_pow10(int power)
{
   ...
   /* Handles negative exponent with a reciprocal at the end because
...
png_exp8bit(png_fixed_point lg2)
{
   ...
   /* Converts the 32-bit value to 0..255 by multiplying by 256-1, note that the
...
png_exp16bit(png_fixed_point lg2)
{
   ...
   /* Converts the 32-bit value to 0..65535 by multiplying by 65536-1: */
   x -= x >> 16;
...
/* Builds a single 8-bit table: same as the 16-bit case but much simpler (and
...
png_build_gamma_table(png_structrp png_ptr, int bit_depth)
{
  ...
  /* Removes any existing table; this copes with multiple calls to
