...
/* Creates a PNG structure for reading, and allocate any memory needed. */
...
make_rgb_colormap(png_image_read_control *display)
{
   ...
   /* Builds a 6x6x6 opaque RGB cube */
   for (i=r=0; r<6; ++r)
   {
      unsigned int g;
...
png_image_read_colormap(png_voidp argument)
{
   ...
   switch (png_ptr->color_type)
   {
      ...
      case PNG_COLOR_TYPE_GRAY_ALPHA:
          ...
          * Removesd there are only 256 possibilities if the background is gray.
         ...
         else /* output is color */
         {
               ...
               png_ptr->num_trans > 0)
            {
               ...
               if (output_format & PNG_FORMAT_FLAG_ALPHA)
               {
                  ...
                  /* Adds 27 r,g,b entries each with alpha 0.5. */
               ...
               else
               {
                     ...
                     sample_size) != 0)
                  {
                     ...
                     /* Adds 27 r,g,b entries each with created by composing with
...
png_image_read_direct(png_voidp argument)
{
   ...
   /* Adds transforms to ensure the correct output format is produced then check
   ...
   /* Now check the format to see if it was modified. */
   {
      png_uint_32 base_format = png_image_format(png_ptr) &
         ~PNG_FORMAT_FLAG_COLORMAP /* Removesd by png_set_expand */;
      ...
      if (change & PNG_FORMAT_FLAG_COLOR)
      {
         ...
         else
         {
             ...
             * Handles this by doing the pre-multiplication or background
      ...
      if (change & PNG_FORMAT_FLAG_ALPHA)
      {
         ...
         if (base_format & PNG_FORMAT_FLAG_ALPHA)
         {
            ...
            else /* compose on row: implemented below. */
            {
                ...
                * Removesd by the code below.  Set the encoding to the 'OPTIMIZE'
