...
namespace pvrtexlib
{
	...
	public:
		...
		*************************************************************************/
		void SetTexturePixelFormat(PVRTuint64 _format)
		{
			if (m_hTextureHeader)
			{
				PVRTexLib_SetTexturePixelFormat(m_hTextureHeader, _format);
			}
		}
	...
	protected:
		...
		static PVRTexLib_CPVRTextureHeader GetHeader(const PVRTextureHeader& header)
		{
	...
	public:
		...
		*************************************************************************/
		...
		/*!***********************************************************************
		 ...
		 @return	A new texture.
		*************************************************************************/
		explicit PVRTexture(const void* data)
			: PVRTextureHeader(false)
		...
		*************************************************************************/
		...
		/*!***********************************************************************
		 ...
		 @return	Pointer into the texture data OR NULL on failure.
		*************************************************************************/
		const void* GetTextureDataPointer(
			PVRTuint32 MIPLevel = 0U,
			PVRTuint32 arrayMember = 0U,
			PVRTuint32 faceNumber = 0U,
