...
static inline GLenum glGetFormatFromInternalFormat( const GLenum internalFormat )
{
	switch ( internalFormat )
	{
		...
		case GL_ALPHA8_SNORM:									return GL_ALPHA;
		case GL_ALPHA8UI_EXT:									return GL_ALPHA_INTEGER;
		case GL_ALPHA8I_EXT:									return GL_ALPHA_INTEGER;
		case GL_ALPHA12:										return GL_ALPHA;
		case GL_ALPHA16:										return GL_ALPHA;
		case GL_ALPHA16_SNORM:									return GL_ALPHA;
		case GL_ALPHA16UI_EXT:									return GL_ALPHA_INTEGER;
		case GL_ALPHA16I_EXT:									return GL_ALPHA_INTEGER;
		case GL_ALPHA16F_ARB:									return GL_ALPHA;
		case GL_ALPHA32UI_EXT:									return GL_ALPHA_INTEGER;
		case GL_ALPHA32I_EXT:									return GL_ALPHA_INTEGER;
		case GL_ALPHA32F_ARB:									return GL_ALPHA;

		case GL_LUMINANCE4:										return GL_LUMINANCE;
		case GL_LUMINANCE8:										return GL_LUMINANCE;
		case GL_LUMINANCE8_SNORM:								return GL_LUMINANCE;
		case GL_SLUMINANCE8:									return GL_LUMINANCE;
		case GL_LUMINANCE8UI_EXT:								return GL_LUMINANCE_INTEGER;
		case GL_LUMINANCE8I_EXT:								return GL_LUMINANCE_INTEGER;
		case GL_LUMINANCE12:									return GL_LUMINANCE;
		case GL_LUMINANCE16:									return GL_LUMINANCE;
		case GL_LUMINANCE16_SNORM:								return GL_LUMINANCE;
		case GL_LUMINANCE16UI_EXT:								return GL_LUMINANCE_INTEGER;
		case GL_LUMINANCE16I_EXT:								return GL_LUMINANCE_INTEGER;
		case GL_LUMINANCE16F_ARB:								return GL_LUMINANCE;
		case GL_LUMINANCE32UI_EXT:								return GL_LUMINANCE_INTEGER;
		case GL_LUMINANCE32I_EXT:								return GL_LUMINANCE_INTEGER;
		...
		case GL_LUMINANCE8_ALPHA8_SNORM:						return GL_LUMINANCE_ALPHA;
		case GL_SLUMINANCE8_ALPHA8:								return GL_LUMINANCE_ALPHA;
		case GL_LUMINANCE_ALPHA8UI_EXT:							return GL_LUMINANCE_ALPHA_INTEGER;
		case GL_LUMINANCE_ALPHA8I_EXT:							return GL_LUMINANCE_ALPHA_INTEGER;
		...
		case GL_LUMINANCE16_ALPHA16_SNORM:						return GL_LUMINANCE_ALPHA;
		case GL_LUMINANCE_ALPHA16UI_EXT:						return GL_LUMINANCE_ALPHA_INTEGER;
		case GL_LUMINANCE_ALPHA16I_EXT:							return GL_LUMINANCE_ALPHA_INTEGER;
		case GL_LUMINANCE_ALPHA16F_ARB:							return GL_LUMINANCE_ALPHA;
		case GL_LUMINANCE_ALPHA32UI_EXT:						return GL_LUMINANCE_ALPHA_INTEGER;
		case GL_LUMINANCE_ALPHA32I_EXT:							return GL_LUMINANCE_ALPHA_INTEGER;
		case GL_LUMINANCE_ALPHA32F_ARB:							return GL_LUMINANCE_ALPHA;

		case GL_INTENSITY4:										return GL_LUMINANCE;
		case GL_INTENSITY8:										return GL_LUMINANCE;
		case GL_INTENSITY8_SNORM:								return GL_LUMINANCE;
		case GL_INTENSITY8UI_EXT:								return GL_LUMINANCE_INTEGER;
		case GL_INTENSITY8I_EXT:								return GL_LUMINANCE_INTEGER;
		case GL_INTENSITY12:									return GL_LUMINANCE;
		case GL_INTENSITY16:									return GL_LUMINANCE;
		case GL_INTENSITY16_SNORM:								return GL_LUMINANCE;
		case GL_INTENSITY16UI_EXT:								return GL_LUMINANCE_INTEGER;
		case GL_INTENSITY16I_EXT:								return GL_LUMINANCE_INTEGER;
		case GL_INTENSITY16F_ARB:								return GL_LUMINANCE;
		case GL_INTENSITY32UI_EXT:								return GL_LUMINANCE_INTEGER;
		case GL_INTENSITY32I_EXT:								return GL_LUMINANCE_INTEGER;
		case GL_INTENSITY32F_ARB:								return GL_LUMINANCE;
		...
		case GL_COMPRESSED_INTENSITY:							return GL_LUMINANCE;
...
static inline GLenum glGetTypeFromInternalFormat( const GLenum internalFormat )
{
	switch ( internalFormat )
	{
		...
		case GL_RGB4:											return GL_UNSIGNED_BYTE;				// L. Spiro: Was GL_UNSIGNED_SHORT_4_4_4_4;		// 3-component 4:4:4,       unsigned normalized
		case GL_RGB5:											return GL_UNSIGNED_BYTE;				// L. Spiro: Was GL_UNSIGNED_SHORT_5_5_5_1.		// 3-component 5:5:5,       unsigned normalized
		case GL_RGB565:											return GL_UNSIGNED_SHORT_5_6_5;			// 3-component 5:6:5,       unsigned normalized
		case GL_RGB10:											return GL_UNSIGNED_SHORT;				// L. Spiro: Was GL_UNSIGNED_INT_10_10_10_2;		// 3-component 10:10:10,    unsigned normalized
		...
		// ========
		// L. Spiro
		case GL_ALPHA4:											return GL_UNSIGNED_BYTE;
		case GL_ALPHA8:											return GL_UNSIGNED_BYTE;
		case GL_ALPHA8_SNORM:									return GL_BYTE;
		case GL_ALPHA8UI_EXT:									return GL_UNSIGNED_BYTE;
		case GL_ALPHA8I_EXT:									return GL_BYTE;
		case GL_ALPHA12:										return GL_UNSIGNED_SHORT;
		case GL_ALPHA16:										return GL_UNSIGNED_SHORT;
		case GL_ALPHA16_SNORM:									return GL_SHORT;
		case GL_ALPHA16UI_EXT:									return GL_UNSIGNED_SHORT;
		case GL_ALPHA16I_EXT:									return GL_SHORT;
		case GL_ALPHA16F_ARB:									return GL_HALF_FLOAT;
		case GL_ALPHA32UI_EXT:									return GL_UNSIGNED_INT;
		case GL_ALPHA32I_EXT:									return GL_INT;
		case GL_ALPHA32F_ARB:									return GL_FLOAT;
		case GL_LUMINANCE4:										return GL_UNSIGNED_BYTE;
		case GL_LUMINANCE8:										return GL_UNSIGNED_BYTE;
		case GL_LUMINANCE8_SNORM:								return GL_BYTE;
		case GL_SLUMINANCE8:									return GL_UNSIGNED_BYTE;
		case GL_LUMINANCE8UI_EXT:								return GL_UNSIGNED_BYTE;
		case GL_LUMINANCE8I_EXT:								return GL_BYTE;
		case GL_LUMINANCE12:									return GL_UNSIGNED_SHORT;
		case GL_LUMINANCE16:									return GL_UNSIGNED_SHORT;
		case GL_LUMINANCE16_SNORM:								return GL_SHORT;
		case GL_LUMINANCE16UI_EXT:								return GL_UNSIGNED_SHORT;
		case GL_LUMINANCE16I_EXT:								return GL_SHORT;
		case GL_LUMINANCE16F_ARB:								return GL_HALF_FLOAT;
		case GL_LUMINANCE32UI_EXT:								return GL_UNSIGNED_INT;
		case GL_LUMINANCE32I_EXT:								return GL_INT;
		case GL_LUMINANCE32F_ARB:								return GL_FLOAT;
		case GL_LUMINANCE4_ALPHA4:								return GL_UNSIGNED_BYTE;
		case GL_LUMINANCE6_ALPHA2:								return GL_UNSIGNED_BYTE;
		case GL_LUMINANCE8_ALPHA8:								return GL_UNSIGNED_BYTE;
		case GL_LUMINANCE8_ALPHA8_SNORM:						return GL_BYTE;
		case GL_SLUMINANCE8_ALPHA8:								return GL_UNSIGNED_BYTE;
		case GL_LUMINANCE_ALPHA8UI_EXT:							return GL_UNSIGNED_BYTE;
		case GL_LUMINANCE_ALPHA8I_EXT:							return GL_BYTE;
		case GL_LUMINANCE12_ALPHA4:								return GL_UNSIGNED_SHORT;
		case GL_LUMINANCE12_ALPHA12:							return GL_UNSIGNED_SHORT;
		case GL_LUMINANCE16_ALPHA16:							return GL_UNSIGNED_SHORT;
		case GL_LUMINANCE16_ALPHA16_SNORM:						return GL_SHORT;
		case GL_LUMINANCE_ALPHA16UI_EXT:						return GL_UNSIGNED_SHORT;
		case GL_LUMINANCE_ALPHA16I_EXT:							return GL_SHORT;
		case GL_LUMINANCE_ALPHA16F_ARB:							return GL_HALF_FLOAT;
		case GL_LUMINANCE_ALPHA32UI_EXT:						return GL_UNSIGNED_INT;
		case GL_LUMINANCE_ALPHA32I_EXT:							return GL_INT;
		case GL_LUMINANCE_ALPHA32F_ARB:							return GL_FLOAT;
		case GL_INTENSITY4:										return GL_UNSIGNED_BYTE;
		case GL_INTENSITY8:										return GL_UNSIGNED_BYTE;
		case GL_INTENSITY8_SNORM:								return GL_BYTE;
		case GL_INTENSITY8UI_EXT:								return GL_UNSIGNED_BYTE;
		case GL_INTENSITY8I_EXT:								return GL_BYTE;
		case GL_INTENSITY12:									return GL_UNSIGNED_SHORT;
		case GL_INTENSITY16:									return GL_UNSIGNED_SHORT;
		case GL_INTENSITY16_SNORM:								return GL_SHORT;
		case GL_INTENSITY16UI_EXT:								return GL_UNSIGNED_SHORT;
		case GL_INTENSITY16I_EXT:								return GL_SHORT;
		case GL_INTENSITY16F_ARB:								return GL_HALF_FLOAT;
		case GL_INTENSITY32UI_EXT:								return GL_UNSIGNED_INT;
		case GL_INTENSITY32I_EXT:								return GL_INT;
		case GL_INTENSITY32F_ARB:								return GL_FLOAT;
		case GL_COMPRESSED_RED:									return GL_UNSIGNED_BYTE;
		case GL_COMPRESSED_ALPHA:								return GL_UNSIGNED_BYTE;
		case GL_COMPRESSED_LUMINANCE:							return GL_UNSIGNED_BYTE;
		case GL_COMPRESSED_SLUMINANCE:							return GL_UNSIGNED_BYTE;
		case GL_COMPRESSED_LUMINANCE_ALPHA:						return GL_UNSIGNED_BYTE;
		case GL_COMPRESSED_SLUMINANCE_ALPHA:					return GL_UNSIGNED_BYTE;
		case GL_COMPRESSED_INTENSITY:							return GL_UNSIGNED_BYTE;
		case GL_COMPRESSED_RG:									return GL_UNSIGNED_BYTE;
		case GL_COMPRESSED_RGB:									return GL_UNSIGNED_BYTE;
		case GL_COMPRESSED_RGBA:								return GL_UNSIGNED_BYTE;
		case GL_COMPRESSED_SRGB:								return GL_UNSIGNED_BYTE;
		case GL_COMPRESSED_SRGB_ALPHA:							return GL_UNSIGNED_BYTE;
		// ========
		default:												return GL_INVALID_VALUE;
	}
}
...
static inline void glGetFormatSize( const GLenum internalFormat, ktxFormatSize * pFormatSize )
{
	...
	switch ( internalFormat )
	{
		...
		case GL_RGB4:											// 3-component 4:4:4, unsigned normalized
			pFormatSize->flags = KTX_FORMAT_SIZE_PACKED_BIT;
			pFormatSize->paletteSizeInBits = 0;
			pFormatSize->blockSizeInBits = 24;	// L. Spiro: Was 12.
			pFormatSize->blockWidth = 1;
			pFormatSize->blockHeight = 1;
			pFormatSize->blockDepth = 1;
			break;
		case GL_RGB5:											// 3-component 5:5:5, unsigned normalized
			pFormatSize->flags = KTX_FORMAT_SIZE_PACKED_BIT;
			pFormatSize->paletteSizeInBits = 0;
			pFormatSize->blockSizeInBits = 24;	// L. Spiro: Was 16.
			pFormatSize->blockWidth = 1;
			pFormatSize->blockHeight = 1;
			pFormatSize->blockDepth = 1;
			break;
		...
		case GL_RGBA2:											// 4-component 2:2:2:2, unsigned normalized
			pFormatSize->flags = KTX_FORMAT_SIZE_PACKED_BIT;
			pFormatSize->paletteSizeInBits = 0;
			pFormatSize->blockSizeInBits = 32;	// L. Spiro: Was 8;
			pFormatSize->blockWidth = 1;
			pFormatSize->blockHeight = 1;
			pFormatSize->blockDepth = 1;
			break;
		...
		case GL_COMPRESSED_RGB:
			pFormatSize->flags = 0;
			pFormatSize->paletteSizeInBits = 0;
			pFormatSize->blockSizeInBits = 24;
			pFormatSize->blockWidth = 1;
			pFormatSize->blockHeight = 1;
			pFormatSize->blockDepth = 1;
			break;
