...
#ifndef __LSE_METALVIEWCONTROLLER_H__
#define __LSE_METALVIEWCONTROLLER_H__
...
@interface LSMetalViewController : UIViewController {
	// == Members.
	/** The game pointer. */
	lse::CGame *								m_pgGame;
...
// == Properties.
@property (strong, nonatomic) CMetalObject *	metalObject;
...
#endif	// __LSE_METALVIEWCONTROLLER_H__
