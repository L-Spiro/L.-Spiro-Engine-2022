...
#include "LSSStreamingSoundSource2d.h"


namespace lss {

	// == Various constructors.
	LSE_CALLCTOR CStreamingSoundSource2d::CStreamingSoundSource2d( uint32_t _ui32Id ) :
		Parent( _ui32Id ) {
	}
	LSE_CALLCTOR CStreamingSoundSource2d::~CStreamingSoundSource2d() {
	}
	 ...
	 */
	LSS_SOUND_SOURCE LSE_CALL CStreamingSoundSource2d::GetType() const {
	 ...
	 */
	void LSE_CALL CStreamingSoundSource2d::ApplyStates() {
	 ...
	 */
	LSBOOL LSE_CALL CStreamingSoundSource2d::DeviceActivated() {
