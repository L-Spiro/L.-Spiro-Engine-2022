...
#ifndef __LSS_STATICSOUNDSOURCE3D_H__
#define __LSS_STATICSOUNDSOURCE3D_H__
...
namespace lss {
	 ...
	 */
	class CStaticSoundSource3d : public CStaticSoundSource {
	public :
		// == Various constructors.
		LSE_CALLCTOR									CStaticSoundSource3d( uint32_t _ui32Id );
		virtual LSE_CALLCTOR							~CStaticSoundSource3d();
...
#endif	// __LSS_STATICSOUNDSOURCE3D_H__
