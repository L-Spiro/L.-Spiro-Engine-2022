/* A Bison CPreProcParser, made by GNU Bison 2.4.2.  */
...
/* As a special exception, you may create a larger work that contains
   part or all of the Bison CPreProcParser skeleton and distribute that work
   under terms of your choice, so long as that work isn't itself a
   CPreProcParser generator using the skeleton or a modified version thereof
   as a CPreProcParser skeleton.  Alternatively, if you modify or redistribute
   the CPreProcParser skeleton itself, you may (at your option) remove this
...
namespace yy {
  ...
  std::string
  CPreProcParser::yytnamerr_ (const char *yystr)
  {
    if (*yystr == '"')
      {
        std::string yyr = "";
  ...
  CPreProcParser::CPreProcParser (class CPreProcLexer * _ppplLexer, class CPreProcContainer * m_pppcContainer_yyarg)
    :
#if YYDEBUG
      yydebug_ (false),
      yycdebug_ (&std::cerr),
#endif
      m_ppplLexer (_ppplLexer),
      m_pppcContainer (m_pppcContainer_yyarg)
  {
  }

  CPreProcParser::~CPreProcParser ()
  {
  }
  ...
  inline void
  CPreProcParser::yy_symbol_value_print_ (int yytype,
  ...
  void
  CPreProcParser::yy_symbol_print_ (int yytype,
			   const semantic_type* yyvaluep, const location_type* yylocationp)
  {
  ...
  void
  CPreProcParser::yydestruct_ (const char* yymsg,
  ...
  void
  CPreProcParser::yypop_ (unsigned int n)
  {
...
#if YYDEBUG
  std::ostream&
  CPreProcParser::debug_stream () const
  {
    return *yycdebug_;
  }

  void
  CPreProcParser::set_debug_stream (std::ostream& o)
  {
    yycdebug_ = &o;
  }


  CPreProcParser::debug_level_type
  CPreProcParser::debug_level () const
  {
    return yydebug_;
  }

  void
  CPreProcParser::set_debug_level (debug_level_type l)
  {
    yydebug_ = l;
  }
#endif
  ...
  yybackup:
    ...
    /* Converts token to internal form.  */
    if (yychar <= yyeof_)
      {
  ...
  case 23:
    ...
    { m_pppcContainer->CreateMath( (yysemantic_stack_[(3) - (1)].ndData), (yysemantic_stack_[(3) - (3)].ndData), token::LSG_PPT_SHIFT_LEFT, (yyval.ndData) ); }
    break;

  case 24:

    { m_pppcContainer->CreateMath( (yysemantic_stack_[(3) - (1)].ndData), (yysemantic_stack_[(3) - (3)].ndData), token::LSG_PPT_SHIFT_RIGHT, (yyval.ndData) ); }
    break;
  ...
  case 28:
    ...
    { m_pppcContainer->CreateMath( (yysemantic_stack_[(3) - (1)].ndData), (yysemantic_stack_[(3) - (3)].ndData), token::LSG_PPT_GE, (yyval.ndData) ); }
    break;

  case 29:

    { m_pppcContainer->CreateMath( (yysemantic_stack_[(3) - (1)].ndData), (yysemantic_stack_[(3) - (3)].ndData), token::LSG_PPT_LE, (yyval.ndData) ); }
    break;
  ...
  case 31:
    ...
    { m_pppcContainer->CreateMath( (yysemantic_stack_[(3) - (1)].ndData), (yysemantic_stack_[(3) - (3)].ndData), token::LSG_PPT_EQUALS, (yyval.ndData) ); }
    break;

  case 32:

    { m_pppcContainer->CreateMath( (yysemantic_stack_[(3) - (1)].ndData), (yysemantic_stack_[(3) - (3)].ndData), token::LSG_PPT_NOT_EQUALS, (yyval.ndData) ); }
    break;
  ...
  case 40:
    ...
    { m_pppcContainer->CreateMath( (yysemantic_stack_[(3) - (1)].ndData), (yysemantic_stack_[(3) - (3)].ndData), token::LSG_PPT_AND, (yyval.ndData) ); }
    break;
  ...
  case 42:
    ...
    { m_pppcContainer->CreateMath( (yysemantic_stack_[(3) - (1)].ndData), (yysemantic_stack_[(3) - (3)].ndData), token::LSG_PPT_OR, (yyval.ndData) ); }
    break;
  ...
  std::string
  CPreProcParser::yysyntax_error_ (int yystate)
  {
    std::string res;
    YYUSE (yystate);
#if YYERROR_VERBOSE
  ...
  /* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
     STATE-NUM.  */
  const signed char CPreProcParser::yypact_ninf_ = -19;
  const signed char
  CPreProcParser::yypact_[] =
  {
  ...
  const signed char CPreProcParser::yytable_ninf_ = -1;
  const unsigned char
  CPreProcParser::yytable_[] =
  {
  ...
  CPreProcParser::yytoken_number_[] =
  {
  ...
  const char*
  const CPreProcParser::yytname_[] =
  {
    "$end", "error", "$undefined", "LSG_PPT_DEFINED",
  "LSG_PPT_CHAR_CONSTANT", "LSG_PPT_FLOAT_CONSTANT",
  "LSG_PPT_DEC_CONSTANT", "LSG_PPT_HEX_CONSTANT", "LSG_PPT_OCT_CONSTANT",
  "LSG_PPT_IDENTIFIER", "LSG_PPT_SHIFT_LEFT", "LSG_PPT_SHIFT_RIGHT",
  "LSG_PPT_AND", "LSG_PPT_OR", "LSG_PPT_GE", "LSG_PPT_LE",
  "LSG_PPT_EQUALS", "LSG_PPT_NOT_EQUALS", "LSG_PPT_NOT",
  "LSG_PPT_1SCOMPLIMENT", "LSG_PPT_UMINUS", "LSG_PPT_UPLUS", "'|'", "'^'",
  "'&'", "'>'", "'<'", "'+'", "'-'", "'*'", "'/'", "'%'", "'('", "')'",
  ...
  const CPreProcParser::rhs_number_type
  CPreProcParser::yyrhs_[] =
  {
  ...
  void
  CPreProcParser::yy_reduce_print_ (int yyrule)
  {
  ...
  CPreProcParser::token_number_type
  CPreProcParser::yytranslate_ (int t)
  {
    static
  ...
  const int CPreProcParser::yyeof_ = 0;
  const int CPreProcParser::yylast_ = 69;
  const int CPreProcParser::yynnts_ = 18;
  const int CPreProcParser::yyempty_ = -2;
  const int CPreProcParser::yyfinal_ = 50;
  const int CPreProcParser::yyterror_ = 1;
  const int CPreProcParser::yyerrcode_ = 256;
  const int CPreProcParser::yyntokens_ = 38;

  const unsigned int CPreProcParser::yyuser_token_number_max_ = 276;
  const CPreProcParser::token_number_type CPreProcParser::yyundef_token_ = 2;
