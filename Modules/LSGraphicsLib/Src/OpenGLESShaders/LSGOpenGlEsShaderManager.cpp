...
namespace lsg {
	...
	LSE_CALLCTOR COpenGlEsShaderManager::COpenGlEsShaderManager() :
	 ...
	 */
	void LSE_CALL COpenGlEsShaderManager::SetShader( CShader * _psShader ) {
	 ...
	 */
	CShader * LSE_CALL COpenGlEsShaderManager::GetShader() {
	 ...
	 */
	void LSE_CALL COpenGlEsShaderManager::PrepareForRender() {
		if ( m_psActiveShader ) {
		}
	}
