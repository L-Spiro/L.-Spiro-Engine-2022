...
#ifndef __LSG_OPENGLESSHADERPROGRAMMANAGER_H__
#define __LSG_OPENGLESSHADERPROGRAMMANAGER_H__
...
namespace lsg {
	...
	/**
	 * Class COpenGlEsShaderProgramManager
	 * \brief Allows sharing of shader programs in OpenGL ES.
	 *
	 * Description: In OpenGL ES, shader programs are made by linking shader parts together.  In L. Spiro Engine, shader
	 *	parts are automatically shared (optionally disablable for multi-context situations), reducing the total possible
	 *	unique combinations between shader parts, meaning that it is very possible for entire shader programs to be
	...
	public :
		 ...
		 * \brief A shader program in OpenGL ES.
		 *
		 * Description: A shader program wrapper for OpenGL ES.
		 */
		class COpenGlEsShaderProgram {
		public :
			// == Various constructors.
			LSE_CALLCTOR												COpenGlEsShaderProgram();
			LSE_CALLCTOR												~COpenGlEsShaderProgram();
			 ...
			 */
			void LSE_CALL												AddShader( COpenGlEsCompiledShader * _pogcsShader );
			 ...
			 */
			COpenGlEsCompiledShader * LSE_CALL							GetShader( LSG_SHADER_TYPES _stShaderType );
			 ...
			 * \return Returns a pointer to the shader set in the given slot.  Returns NULL for empty slots.
			 */
			const COpenGlEsCompiledShader * LSE_CALL						GetShader( LSG_SHADER_TYPES _stShaderType ) const;
		...
		protected :
			 ...
			 * The shaders to link.
			 */
			COpenGlEsCompiledShader *									m_pogcsShader[LSG_ST_TOTAL];
		...
		private :
			friend class												COpenGlEsShaderProgramManager;
		};
		 ...
		 */
		static COpenGlEsShaderProgram * LSE_CALL							CreateShaderProgram( COpenGlEsCompiledShader * _pogcsVertexShader,
		 ...
		 */
		static void LSE_CALL											DeleteShaderProgram( COpenGlEsShaderProgram * _pogspProgram );
	...
	protected :
		...
		static CLinearMap<LSG_SHADER_PROGRAM_KEY, COpenGlEsShaderProgram *>
																		m_mShaders;
		 ...
		 */
		static LSG_SHADER_PROGRAM_KEY LSE_CALL							CreateKey( const COpenGlEsShaderProgram &_ogspProgram );
	};
...
#endif	// __LSG_OPENGLESSHADERPROGRAMMANAGER_H__
