...
#ifndef __LSG_OPENGLESSHADER_H__
#define __LSG_OPENGLESSHADER_H__
...
namespace lsg {
	...
	class COpenGlEsShaderManager;

	/**
	 * Class COpenGlEsShader
	 * \brief Open OpenGL ES shader.
	 *
	 * Description: Open OpenGL ES shader.  Specifically for OpenGL ES, after shaders are translated, they are linked
	 *	into an OpenGL ES program object.  A shader program in OpenGL ES is a combination of a vertex shader, pixel
	 *	shader, and geometry shader.  Each of these are called shader parts in this context, and shader parts
	 ...
	 *	reduces significantly the number of shader swaps that need to be made during rendering.
	 */
	class COpenGlEsShader : public CShaderBase {
	public :
		// == Various constructors.
		LSE_CALLCTOR							COpenGlEsShader();
		virtual LSE_CALLCTOR					~COpenGlEsShader();
		 ...
		 */
		const COpenGlEsShaderProgramManager::LSG_ATTRIBUTE_USAGE_LOCS * LSE_CALL
	...
	protected :
		 ...
		 */
		COpenGlEsCompiledShader *				m_pogcsShaders[LSG_ST_TOTAL];

		/**
		 * The shader program with all of the shader parts linked.
		 */
		COpenGlEsShaderProgramManager::COpenGlEsShaderProgram *
												m_pospProgram;

		/**
		 * The shader manager to which this shader is applied, if any.
		 */
		COpenGlEsShaderManager *				m_pogsmShaderMan;
	...
	private :
		...
		friend class							COpenGlEsShaderManager;
	};
...
#endif	// __LSG_OPENGLESSHADER_H__
