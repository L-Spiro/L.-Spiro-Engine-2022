...
#ifndef __LSG_OPENGLESCOMPILEDSHADER_H__
#define __LSG_OPENGLESCOMPILEDSHADER_H__
...
namespace lsg {
	...
	/**
	 * Class COpenGlEsCompiledShader
	 * \brief A compiled shader part (vertex, pixel, geometry, etc.) for OpenGL ES.
	 *
	 * Description: A compiled shader part (vertex, pixel, geometry, etc.) for OpenGL ES.  After being compiled, the
	 *	managing shader object will perform the linking.
	 */
	class COpenGlEsCompiledShader : public CCompiledShaderBase {
	public :
		// == Various constructors.
		LSE_CALLCTOR							COpenGlEsCompiledShader();
		LSE_CALLCTOR							~COpenGlEsCompiledShader();
		 ...
		 */
		static LSBOOL LSE_CALL					PrintShaderError( GLuint _uiShader, CString &_sError );
	...
	private :
		...
		friend class							COpenGlEsCompiledShaderManager;
	};
...
#endif	// __LSG_OPENGLESCOMPILEDSHADER_H__
