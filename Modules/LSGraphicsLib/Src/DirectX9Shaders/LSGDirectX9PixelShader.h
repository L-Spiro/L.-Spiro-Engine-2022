...
#ifndef __LSG_DIRECTX9PIXELSHADER_H__
#define __LSG_DIRECTX9PIXELSHADER_H__
...
namespace lsg {
	 ...
	 * \brief A pixel shader in DirectX 9.
	 *
	 * Description: A pixel shader in DirectX 9.  This is used by CDirectX9Shader as one of its components.  These
	 *	objects are shared by default, managed by the CDirectX9CompiledShaderManager class.
	 */
	class CDirectX9PixelShader : public CDirectX9CompiledShader {
	public :
		// == Various constructors.
		LSE_CALLCTOR										CDirectX9PixelShader();
		virtual LSE_CALLCTOR								~CDirectX9PixelShader();
	...
	protected :
		 ...
		 */
		IDirect3DPixelShader9 *								m_pps9PixelShader;
...
#endif	// __LSG_DIRECTX9PIXELSHADER_H__
