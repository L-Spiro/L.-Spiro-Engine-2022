 ...
 *
 *
 * Description: Manages the interface between shader objects and the OpenGL API.  Its main function is to apply
...
namespace lsg {
	...
	LSE_CALLCTOR COpenGlShaderManager::COpenGlShaderManager() :
	 ...
	 */
	void LSE_CALL COpenGlShaderManager::SetShader( CShader * _psShader ) {
	 ...
	 */
	CShader * LSE_CALL COpenGlShaderManager::GetShader() {
	 ...
	 */
	void LSE_CALL COpenGlShaderManager::PrepareForRender() {
		if ( m_psActiveShader ) {
