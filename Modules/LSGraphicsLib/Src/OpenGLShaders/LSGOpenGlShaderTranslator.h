...
#ifndef __LSG_OPENGLSHADERTRANSLATOR_H__
#define __LSG_OPENGLSHADERTRANSLATOR_H__
...
namespace lsg {
	...
	/**
	 * Class COpenGlShaderTranslator
	 * \brief Translates from the engine shader language to GLSL.
	 *
	 * Description: Translates from the engine shader language to GLSL.
	 */
	class COpenGlShaderTranslator : public CShaderTranslationProcessorBase {
	public :
		// == Various constructors.
		LSE_CALLCTOR										COpenGlShaderTranslator();
		virtual LSE_CALLCTOR								~COpenGlShaderTranslator();
...
#endif	// __LSG_OPENGLSHADERTRANSLATOR_H__
