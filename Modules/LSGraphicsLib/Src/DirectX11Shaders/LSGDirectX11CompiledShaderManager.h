...
#ifndef __LSG_DIRECTX11COMPILERDSHADERMANAGER_H__
#define __LSG_DIRECTX11COMPILERDSHADERMANAGER_H__
...
namespace lsg {
	 ...
	 * \brief Manages the sharing of a single Direct3D 11 shader (vertex or pixel shader).
	 *
	 * Description: Manages the sharing of a single Direct3D 11 shader (vertex or pixel shader).  Sharing is based
	 *	off the (adjusted) shader text for the sake of speed.  The alternative--sharing based off compiled code--
	 *	makes loading times too long.
...
#endif	// __LSG_DIRECTX11COMPILERDSHADERMANAGER_H__
