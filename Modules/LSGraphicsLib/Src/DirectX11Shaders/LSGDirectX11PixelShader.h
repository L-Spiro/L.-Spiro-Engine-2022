...
#ifndef __LSG_DIRECTX11PIXELSHADER_H__
#define __LSG_DIRECTX11PIXELSHADER_H__
...
namespace lsg {
	 ...
	 * \brief A pixel shader in DirectX 11.
	 *
	 * Description: A pixel shader in DirectX 11.  This is used by CDirectX11Shader as one of its components.  These
	 *	objects are shared by default, managed by the CDirectX11CompiledShaderManager class.
	 */
	class CDirectX11PixelShader : public CDirectX11CompiledShader {
	public :
		// == Various constructors.
		LSE_CALLCTOR										CDirectX11PixelShader();
		virtual LSE_CALLCTOR								~CDirectX11PixelShader();
...
#endif	// __LSG_DIRECTX11PIXELSHADER_H__
