 ...
 *
 *
 * Description: Manages the interface between shader objects and the Direct3D 11 API.  Its main function is to apply
...
namespace lsg {
	...
	LSE_CALLCTOR CDirectX11ShaderManager::CDirectX11ShaderManager() :
	 ...
	 */
	void LSE_CALL CDirectX11ShaderManager::SetShader( CShader * _psShader ) {
	 ...
	 */
	CShader * LSE_CALL CDirectX11ShaderManager::GetShader() {
	 ...
	 */
	void LSE_CALL CDirectX11ShaderManager::PrepareForRender() {
		if ( m_psActiveShader ) {
		}
	}
