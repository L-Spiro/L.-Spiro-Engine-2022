...
#ifndef __LSG_DIRECTX11SHADERTRANSLATOR_H__
#define __LSG_DIRECTX11SHADERTRANSLATOR_H__
...
namespace lsg {
	 ...
	 * Description: Translates from the engine shader language to HLSL.
	 */
	class CDirectX11ShaderTranslator : public CShaderTranslationProcessorBase {
	public :
		// == Various constructors.
		LSE_CALLCTOR										CDirectX11ShaderTranslator();
		virtual LSE_CALLCTOR								~CDirectX11ShaderTranslator();
...
#endif	// __LSG_DIRECTX11SHADERTRANSLATOR_H__
