...
#ifndef __LSG_OPENGLESVERTEXBUFFER_H__
#define __LSG_OPENGLESVERTEXBUFFER_H__
...
namespace lsg {
	...
	enum LSG_VERTEX_BUFFER_MAP_ACCESS {
		LSG_VBMA_READ							= GL_MAP_READ_BIT_EXT,							/**< Read-only access. */
		LSG_VBMA_WRITE							= GL_MAP_WRITE_BIT_EXT,							/**< Write-only access. */
		LSG_VBMA_READ_WRITE						= GL_MAP_READ_BIT_EXT | GL_MAP_WRITE_BIT_EXT,	/**< Read and write access. */
		LSG_VBMA_WRITE_DISCARD					= GL_MAP_WRITE_BIT_EXT | GL_MAP_INVALIDATE_RANGE_BIT_EXT,	/**< Write access, discarding previous contents. */

		LSG_VBMA_FORCE_DWORD					= 0x7FFFFFFF
	};

	/**
	 * Class COpenGlEsVertexBuffer
	 * \brief An OpenGL ES vertex buffer.
	 *
	 * Description: An OpenGL ES vertex buffer.
	 */
	class COpenGlEsVertexBuffer : public CVertexBufferBase {
		friend									class COpenGlEsIndexBuffer;
		friend									class CGfx;
	public :
		// == Various constructors.
		LSE_CALLCTOR							COpenGlEsVertexBuffer();
		LSE_CALLCTOR							~COpenGlEsVertexBuffer();
...
#include "../VertexBuffer/LSGVertexBufferCommonDecl.h"
	...
	protected :
		 ...
		 */
		LSBOOL LSE_CALL							SetStreamApi( uint32_t _ui32Index, uint32_t _ui32Offset = 0UL ) const;
	...
	// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	// == Functions.
#define LSG_VBUFCOMMONDEF_CLASS COpenGlEsVertexBuffer
...
#endif	// __LSG_OPENGLESVERTEXBUFFER_H__
