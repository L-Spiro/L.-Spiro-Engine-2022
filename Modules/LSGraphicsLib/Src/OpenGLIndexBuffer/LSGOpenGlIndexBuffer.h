...
#ifndef __LSG_OPENGLINDEXBUFFER_H__
#define __LSG_OPENGLINDEXBUFFER_H__
...
namespace lsg {
	 ...
	 * Description: An OpenGL index buffer.
	 */
	class COpenGlIndexBuffer : public CIndexBufferBase {
		friend									class CGfx;
	public :
		// == Various constructors.
		LSE_CALLCTOR							COpenGlIndexBuffer();
		LSE_CALLCTOR							~COpenGlIndexBuffer();
...
#endif	// __LSG_OPENGLINDEXBUFFER_H__
